...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\n\n\n\n\n\n\n\n\n\n\n\nhtml body {\n    margin: 0;\n    background-color: #f0f0f0;\n    -webkit-overflow-scrolling: touch;\n}\n\n[v-cloak] {\n    display: none;\n}\n", "", {"version":3,"sources":["/./src/components/App.vue?bfa73014"],"names":[],"mappings":";;;;;;;;;;;;AAYA;IACA,UAAA;IACA,0BAAA;IACA,kCAAA;CACA;;AAEA;IACA,cAAA;CACA","file":"App.vue","sourcesContent":["<template>\r\n    <div>\r\n        <router-view></router-view>\r\n    </div>\r\n</template>\r\n\r\n<script>\r\n    export default{}\r\n</script>\r\n\r\n<style>\r\n\r\n    html body {\r\n        margin: 0;\r\n        background-color: #f0f0f0;\r\n        -webkit-overflow-scrolling: touch;\r\n    }\r\n\r\n    [v-cloak] {\r\n        display: none;\r\n    }\r\n</style>"],"sourceRoot":"webpack://"}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    created: function created() {
	        ...
	        this.$http.get('/banners').then(function (response) {
	            new _swiper2.default(response.data);
	        }, function (err) {
	            new _swiper2.default(['http://jiepai-1.img-cn-hangzhou.aliyuncs.com//media/6crSw7KA2nM5ntYatDaFipT2bdxSf8EP1484711324833.jpg', 'http://image.jiepaiapp.com/media/EDw42zMRniykMiP4tCNGPTpkz3rBQhWZ1484711172824.jpg', 'http://image.jiepaiapp.com/media/fJHiyC2YhatSSS3P5jsMcjjHCiybHJBC1483928809304.jpg']);
	        });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Swiper = function () {
	    ...
	    (0, _createClass3.default)(Swiper, [{
	        ...
	        key: 'createElement',
	        value: function createElement(url) {
	            var _this = this;
	
	            var element = this.imagePrototype.cloneNode(false);
	            element.draggable = false;
	            element.src = url;
	
	            (0, _helper2.default)(element).addClass(this.options.slideContentClass);
	
	            setTimeout(function () {
	                _this.container[0].style.height = element.height + 'px';
	            }, 100);
	            return element;
	        }
	        ...
	        key: 'loadElements',
	        value: function loadElements(index) {
	            var limit = Math.min(this.num, 2 * 2 + 1);
	            var j = index;
	        ...
	        value: function initWidget() {
	            ...
	            this.container = (0, _helper2.default)(this.options.container);
	            ...
	            (0, _helper2.default)(this.slidePrototype).addClass(this.options.slideClass);
	        ...
	        key: 'positionSlide',
	        value: function positionSlide(index) {
	        ...
	        key: 'translateX',
	        value: function translateX(index, x, speed) {
	            this.translate(index, x, 0, speed);
	        }
	    }, {
	        key: 'translate',
	        value: function translate(index, x, y, speed) {
	        ...
	        value: function initEventListeners() {
	            ...
	            var proxyListener = function proxyListener(event) {
	                var type = 'transitionend' === event.type || 'webkitTransitionEnd' === event.type ? 'transitionend' : event.type;
	                _this2['on' + type](event);
	            };
	        ...
	        value: function onmouseout(event) {
	            if (this.touchStart) {
	                ...
	                if (!related || related !== target && !_helper2.default.contains(target, related)) {
	        ...
	        value: function ontouchmove(event) {
	            ...
	            var touchDeltaX = this.touchDelta.x;
	            ...
	            if (!this.isScrolling) {
	                ...
	                var indices = [this.circle(this.index + 1), this.index, this.circle(this.index - 1)];
	        ...
	        value: function ontouchend(event) {
	            ...
	            var direction = void 0,
	                indexForward = void 0,
	                indexBackward = void 0,
	                distanceForward = void 0,
	                distanceBackward = void 0;
	        ...
	        value: function goto(to) {
	            ...
	            to = this.circle(to);
	            var direction = -this.positions[to] / this.slideWidth;
	    ...
	    return Swiper;
	      ...
	      * Created by Administrator on 2017/1/20 0019.
	      */
...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _assign2.default)(Helper.prototype, {
